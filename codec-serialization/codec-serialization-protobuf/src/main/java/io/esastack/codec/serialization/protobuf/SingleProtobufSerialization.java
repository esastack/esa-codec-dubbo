...
public class SingleProtobufSerialization implements Serialization {

    @Override
    public byte getSeriTypeId() {
        return PROTOBUF_SINGLE_SERIALIZATION_ID;
    }

    @Override
    public String getContentType() {
        return "x-application/proto";
    }
    ...
    public DataOutputStream serialize(OutputStream output) throws IOException {
        return new SingleProtobufDataOutputStream(output);
    }

    @Override
    public DataInputStream deserialize(InputStream input) throws IOException {
        return new SingleProtobufDataInputStream(input);
    }
}

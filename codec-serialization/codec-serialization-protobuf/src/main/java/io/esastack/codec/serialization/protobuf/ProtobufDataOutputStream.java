...
public class ProtobufDataOutputStream implements DataOutputStream {

    private final OutputStream os;

    public ProtobufDataOutputStream(OutputStream os) {
        this.os = os;
    }
    ...
    public void writeObject(Object obj) throws IOException {
        ...
        ((MessageLite) obj).writeDelimitedTo(os);
        os.flush();
    }

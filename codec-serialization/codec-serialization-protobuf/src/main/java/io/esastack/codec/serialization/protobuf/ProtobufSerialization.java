...
import static io.esastack.codec.serialization.api.SerializeConstants.PROTOBUF_SERIALIZATION_ID;
...
public class ProtobufSerialization implements Serialization {
    ...
    public DataOutputStream serialize(OutputStream output) throws IOException {
        return new ProtobufDataOutputStream(output);
    }

    @Override
    public DataInputStream deserialize(InputStream input) throws IOException {
        return new ProtobufDataInputStream(input);
    }
}

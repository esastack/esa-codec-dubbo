...
import static io.esastack.codec.serialization.api.SerializeConstants.KRYO_SERIALIZATION_ID;
...
public class KryoSerialization implements Serialization {
    ...
    public DataOutputStream serialize(OutputStream out) throws IOException {
        return new KryoDataOutputStream(out);
    }

    @Override
    public DataInputStream deserialize(InputStream is) throws IOException {
        return new KryoDataInputStream(is);
    }
}

...
public class CompatibleKryo extends Kryo {
    ...
    public Serializer getDefaultSerializer(Class type) {
        ...
        /*
         * Kryo requires every class to provide a zero argument constructor. For any class does not match this
         * condition, kryo have two ways:
         ...
         *
         * In practice, it's not possible for Dubbo users to register kryo Serializer for every customized class.
         * So in most cases, customized classes with/without zero argument constructor will
         * default to the default serializer.
         * It is the responsibility of kryo to handle with every standard jdk classes, so we will just escape
         * these classes.
         */

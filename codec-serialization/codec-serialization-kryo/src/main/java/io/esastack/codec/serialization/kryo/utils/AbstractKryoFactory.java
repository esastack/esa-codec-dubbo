...
import io.esastack.codec.serialization.api.SerializableClassRegistry;
import io.esastack.codec.serialization.kryo.CompatibleKryo;
...
public abstract class AbstractKryoFactory implements KryoFactory {
    ...
    private static volatile Class<? extends Serializer> defaultSerializer;
    ...
    public static void setDefaultSerializer(Class<? extends Serializer> serializer) {

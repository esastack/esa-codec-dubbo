...
public class SslContextBuilder {
    ...
    public SslContext buildServer() throws IOException {
        ...
        if (StringUtils.isBlank(keyPassword)) {
            sslContextBuilder = io.netty.handler.ssl.SslContextBuilder.forServer(certificate, privateKey);
        } else {
            sslContextBuilder = io.netty.handler.ssl.SslContextBuilder.forServer(certificate, privateKey, keyPassword);
        }
    ...
    public SslContext buildClient() throws Exception {
        ...
        io.netty.handler.ssl.SslContextBuilder sslContextBuilder = io.netty.handler.ssl.SslContextBuilder.forClient();
    ...
    public SslContextBuilder setCertificate(InputStream certificate) {
        this.certificate = certificate;
        return this;
    }

    public SslContextBuilder setPrivateKey(InputStream privateKey) {
        this.privateKey = privateKey;
        return this;
    }

    public SslContextBuilder setCiphers(String[] ciphers) {
    ...
    public SslContextBuilder setHandshakeTimeoutMillis(long handshakeTimeoutMillis) {
    ...
    public SslContextBuilder setEnabledProtocols(String[] enabledProtocols) {
    ...
    public SslContextBuilder setKeyPassword(String keyPassword) {
    ...
    public SslContextBuilder setTrustCertificates(InputStream trustCertificates) {
